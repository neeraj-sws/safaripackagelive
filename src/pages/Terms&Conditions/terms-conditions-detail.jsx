...
export default function termsconditiondetail() {
    ...
    return (
        <>
         <section id="about-safari-meet" class="my-5">
            <div class="container-lg container-inner-padding">
                <div class="">
                    <p>Welcome to Safari Meet!</p>
                    <p>These terms and conditions outline the rules and regulations for the use of Safari Meet’s
                        Website, located at <a href="https://safari-meet.codelive.info/">https://safari-meet.codelive.info/</a>.</p>
                    <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use
                        https://safari-meet.codelive.info/ if you do not agree to take all of the terms and conditions stated on
                        this page.</p>
                    ...
                    <p>We employ the use of cookies. By accessinghttps://safari-meet.codelive.info/, you agreed to use cookies in
                        agreement with the Safari Meet’s <a href="https://safari-meet.codelive.info/privacy-policy.html">Privacy
                            Policy</a>.</p>
                    ...
                    <p>Unless otherwise stated, Safari Meet and/or its licensors own the intellectual property rights
                        for all material on  https://safari-meet.codelive.info/. All intellectual property rights are reserved. You
                        may access this from  https://safari-meet.codelive.info/ for your own personal use subjected to
                        restrictions set in these terms and conditions.</p>
                    <p><strong>You must not:</strong></p>
                    <ul>
                        <li>Republish material from https://safari-meet.codelive.info/</li>
                        <li>Sell, rent or sub-license material from https://safari-meet.codelive.info/</li>
                        <li>Reproduce, duplicate or copy material from https://safari-meet.codelive.info/</li>
                        <li>Redistribute content from https://safari-meet.codelive.info/</li>
                    </ul>
                    ...
                    <p>Parts of this website offer an opportunity for users to post and exchange opinions and
                        information in certain areas of the website. Safari Meet does not filter, edit, publish or
                        review Comments prior to their presence on the website. Comments do not reflect the views and
                        opinions of Safari Meet, its agents and/or affiliates. Comments reflect the views and
                        opinions of the person who post their views and opinions. To the extent permitted by applicable
                        laws, Safari Meet shall not be liable for the Comments or for any liability, damages or
                    ...
                    <p>Safari Meet reserves the right to monitor all Comments and to remove any Comments which can be
                    ...
                    <p>You hereby grant Safari Meet a non-exclusive license to use, reproduce, edit and authorize
                    ...
                    <p>We will approve link requests from these organizations if we decide that: (a) the link would not
                        ...
                        hyperlink compensates the absence of Safari Meet; and (d) the link is in the context of
                    ...
                    <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to
                        our website, you must inform us by sending an e-mail to Safari Meet. Please include your
                    ...
                    <p>No use of Safari Meet’s logo or other artwork will be allowed for linking absent a trademark
                        license agreement.</p>

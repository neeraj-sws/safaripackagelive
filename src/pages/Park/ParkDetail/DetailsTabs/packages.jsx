...
export default function parkpackages() {
                            ...
                            <div className="card-container row align-items-center justify-content-start gx-3">
                                ...
                                <div className="col-12 text-center mt-4 pt-2">
                                    <a href="javascript:void(0)"
                                        className="text-decoration-none btn-primary blue-btn-hover btn load-btn btn-sm border-0 px-3">
                                        Load More
                                    </a>
                                </div>
                            </div>

                                ...
                                <div className="col-12 col-lg-6 d-sm-flex align-items-center">
                                    ...
                                    <div className="profile-img-wrapper position-relative text-center">
                                        ...
                                        <a href="javascript:void(0);" onClick={handleClick}>
                                            ...
                                            {/* {preview && <img id="profileImagePreview" src={userImg} alt="Profile Preview" />} */}
                                        </a>
                                    </div>
                                    ...
                                    <div className="">
                                        ...
                                        <div className="edit-share ms-3 mt-3 text-sm-start text-center">
                                            <a href="/edit-profile" onClick={goToEdit}
                                                className="btn btn-sm btn-primary blue-btn-hover border-0 rounded-1 me-2">Edit
                                                Profile
                                            </a>
